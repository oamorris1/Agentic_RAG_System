    ...
    def sci_summarize_document(self, agent: Agent, docs_path):
      try:
          return Task(
             ...
             - **Title**
                  - ** DOI** (Digital Object Identifier) if avaialable
                  - **Abstract** (if available)
                  - **Keywords** (if available)
                  - **Full Text Summary** (a detailed deep summary of the paper)
                  - **Authors and Year**
                  - **Research Problem**
                  - **Objectives**
              ...
              IMPORTANT:
              - The summary **must be detailed and comprehensive** and each summaries should be complete and independent**
                of the original paper. There should be several sections of the 
                summary that capture each of the key findings and concepts in the paper
    ...
    def generate_report(self, agent: Agent, summaries_path_json, save_directory):
        try:
            return Task(
                ...
                **Input Data:**  
                - The agent receives a **list of structured research summaries**, Obtain summaries from here: {summaries_path_json} each containing:
                  - **Title**
                  - ** DOI** (Digital Object Identifier) if avaialable
                  - **Abstract** (if available)
                  - **Keywords** (if available)
                ...
                **Formatting Rules:**  
                ...
                - The **sections must be labeled** properly:
                  ...
                  - **Future Research Directions**  
                  - **Key Terms**  
                  - **Summaries should be complete and independent** of the original paper. There should be several sections of the 
                    **Summary that capture each of the key findings and concepts in the paper
                  - **The report should include **an introduction section** that provides context for the research.
                ...
                **Output Format:**  
                ...
                - The report should be **fully standalone**, meaning a researcher can
                  read it and understand the study without needing the original paper.
